...
try:
    ...
    config = lambda name, default=None, cast=str: default
    Csv = lambda value: [v.strip() for v in value.split(',')]
...
SECRET_KEY = config('c9f2814b3750f71faa14e57c17a43d48fe568ae62f568bb9434f3b562103753a')
