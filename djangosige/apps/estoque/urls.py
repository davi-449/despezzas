...
urlpatterns = [
    ...
    path('local/saida/adicionar/', views.AdicionarLocalEstoqueView.as_view(),
        name='addlocalview'),
    # estoque/local/listalocal
    path('local/listalocal/', views.LocalEstoqueListView.as_view(),
        name='listalocalview'),
    # estoque/local/editar/
    path('local/editar/<int:pk>/', views.EditarLocalEstoqueView.as_view(),
    ...
    path('movimento/adicionarentrada/', views.AdicionarEntradaEstoqueView.as_view(),
    ...
    path('movimento/adicionarsaida/', views.AdicionarSaidaEstoqueView.as_view(),
    ...
    path('movimento/editarsaida/<int:pk>/', views.DetalharSaidaEstoqueView.as_view(),
        name='detalharsaidaestoqueview'),

    # TransferenciaEstoque
    # estoque/movimento/adicionartransferencia/
    path('movimento/adicionartransferencia/', views.AdicionarTransferenciaEstoqueView.as_view(),
