...
urlpatterns = [
    ...
    path('empresa/editar/<int:pk>/', views.EditarEmpresaView.as_view(), name='editarempresaview'),
    ...
    path('cliente/editar/<int:pk>/', views.EditarClienteView.as_view(), name='editarclienteview'),
    ...
    path('fornecedor/editar/<int:pk>/', views.EditarFornecedorView.as_view(), name='editarfornecedorview'),
    ...
    path('transportadora/editar/<int:pk>/', views.EditarTransportadoraView.as_view(), name='editartransportadoraview'),
    ...
    path('produto/editar/<int:pk>/', views.EditarProdutoView.as_view(), name='editarprodutoview'),
    ...
    path('outros/editarcategoria/<int:pk>/', views.EditarCategoriaView.as_view(), name='editarcategoriaview'),
    ...
    path('outros/editarunidade/<int:pk>/', views.EditarUnidadeView.as_view(), name='editarunidadeview'),
    ...
    path('outros/editarmarca/<int:pk>/', views.EditarMarcaView.as_view(), name='editarmarcaview'),
