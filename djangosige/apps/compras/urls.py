...
urlpatterns = [
    ...
    path('orcamentocompra/adicionar/', views.AdicionarPedidoCompraView.as_view(), name='addorcamentocompraview'),
    ...
    path('orcamentocompra/editar/<int:pk>/', views.EditarOrcamentoCompraView.as_view(), name='editarorcamentocompraview'),
    ...
    path('pedidocompra/editar/<int:pk>/', views.EditarPedidoCompraView.as_view(), name='editarpedidocompraview'),
    ...
    # Gerar pdf orcamento
    path('gerarpdforcamentocompra/<int:pk>/', views.GerarPDFOrcamentoCompra.as_view(), name='gerarpdforcamentocompra'),
    # Gerar pdf pedido
    path('gerarpdfpedidocompra/<int:pk>/', views.GerarPDFOrcamentoCompra.as_view(), name='gerarpdfpedidocompra'),
    # Gerar pedido a partir de um orçamento
    path('gerarpedidocompra/<int:pk>/', views.GerarPedidoCompraView.as_view(), name='gerarpedidocompra'),
    # Copiar orcamento cancelado ou realizado
    path('copiarorcamentocompra/<int:pk>/', views.GerarCopiaOrcamentoCompraView.as_view(), name='copiarorcamentocompra'),
    # Copiar pedido cancelado ou realizado
    path('copiarpedidocompra/<int:pk>/', views.GerarCopiaPedidoCompraView.as_view(), name='copiarpedidocompra'),
    # Cancelar Pedido de compra
    path('cancelarpedidocompra/<int:pk>/', views.CancelarPedidoCompraView.as_view(), name='cancelarpedidocompra'),
    # Cancelar Orcamento de compra
    path('cancelarorcamentocompra/<int:pk>/', views.CancelarOrcamentoCompraView.as_view(), name='cancelarorcamentocompra'),
    # Receber Pedido de compra
    path('receberpedidocompra/<int:pk>/', views.ReceberPedidoCompraView.as_view(), name='receberpedidocompra'),
]
