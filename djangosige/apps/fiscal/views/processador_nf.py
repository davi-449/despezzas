...
from nfelib import nfse as nfse_310
from nfelib import mdfe_dist_dfe as Det_310
#from nfelib import autxml as autXML_310
#from nfelib import dup as Dup_310
from nfelib import nf_e as NFe_310
from . import processador_nf
...
class ProcessadorNotaFiscal(object):
    ...
    def validar_nota(self, nota_obj):
        ...
        from .processador_nf import NFe_310
    ...
    def consultar_cadastro(self, empresa, salvar_arquivos):
        from nfelib import nfse as NfeClass
        self.nova_nfe = NfeClass
