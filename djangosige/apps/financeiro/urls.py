...
urlpatterns = [
    ...
    path('contapagar/adicionar/', views.AdicionarContaPagarView.as_view(),
        name='addcontapagarview'),
    # financeiro/contapagar/listacontapagar
    path('contapagar/listacontapagar/', views.ContaPagarListView.as_view(),
        name='listacontapagarview'),
    # financeiro/contapagar/editar/
    path('contapagar/editar/<pk>/', views.EditarContaPagarView.as_view(),
        name='editarcontapagarview'),
    # financeiro/contapagar/listacontapagar/atrasadas/
    path('contapagar/listacontapagar/atrasadas/', views.ContaPagarAtrasadasListView.as_view(),
        name='listacontapagaratrasadasview'),
    # financeiro/contapagar/listacontapagar/hoje/
    path('contapagar/listacontapagar/hoje/', views.ContaPagarHojeListView.as_view(),
        name='listacontapagarhojeview'),

    # Contas a receber
    # financeiro/contareceber/adicionar/
    path('contareceber/adicionar/', views.AdicionarContaReceberView.as_view(),
        name='addcontareceberview'),
    # financeiro/contareceber/listacontapagar
    path('contareceber/listacontareceber/', views.ContaReceberListView.as_view(),
        name='listacontareceberview'),
    # financeiro/contareceber/editar/
    path('contareceber/editar/<pk>/', views.EditarContaReceberView.as_view(),
        name='editarcontareceberview'),
    # financeiro/contareceber/listacontapagar/atrasadas/
    path('contareceber/listacontareceber/atrasadas/', views.ContaReceberAtrasadasListView.as_view(),
        name='listacontareceberatrasadasview'),
    # financeiro/contareceber/listacontapagar/hoje/
    path('contareceber/listacontareceber/hoje/', views.ContaReceberHojeListView.as_view(),
        name='listacontareceberhojeview'),

    # Pagamentos
    # financeiro/pagamento/adicionar/
    path('pagamento/adicionar/', views.AdicionarSaidaView.as_view(),
        name='addpagamentoview'),
    # financeiro/pagamento/listacontapagar
    path('pagamento/listapagamento/', views.SaidaListView.as_view(),
        name='listapagamentosview'),
    # financeiro/pagamento/editar/
    path('pagamento/editar/<pk>/', views.EditarSaidaView.as_view(),
        name='editarpagamentoview'),

    # Recebimentos
    # financeiro/recebimento/adicionar/
    path('recebimento/adicionar/', views.AdicionarEntradaView.as_view(),
        name='addrecebimentoview'),
    # financeiro/recebimento/listarecebimento
    path('recebimento/listarecebimento/', views.EntradaListView.as_view(),
        name='listarecebimentosview'),
    # financeiro/recebimento/editar/
    path('recebimento/editar/<pk>/', views.EditarEntradaView.as_view(),
        name='editarrecebimentoview'),

    # Faturar Pedido de venda
    path('faturarpedidovenda/<pk>/', views.FaturarPedidoVendaView.as_view(),
        name='faturarpedidovenda'),
    # Faturar Pedido de compra
    path('faturarpedidocompra/<pk>/', views.FaturarPedidoCompraView.as_view(),
    ...
    path('planodecontas/adicionargrupo/', views.AdicionarGrupoPlanoContasView.as_view(),
        name='addgrupoview'),
    # financeiro/planodecontas/editargrupo/
    path('planodecontas/editargrupo/<pk>/', views.EditarGrupoPlanoContasView.as_view(),
